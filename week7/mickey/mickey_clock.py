...
bg = pygame.image.load(r'D:\Programming\PyCharm ENG\week7\mickey\bb.png').convert()
bg_rect = bg.get_rect()
image_left = pygame.image.load(r"D:\Programming\PyCharm ENG\week7\mickey\second.png")
left_rect = image_left.get_rect(bottomleft = (415,560))
image_right = pygame.image.load(r"D:\Programming\PyCharm ENG\week7\mickey\minute.png")
